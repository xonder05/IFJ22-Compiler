...
prekladac: main.o parser.o scanner.o dyn_string.o testing_utils.o symtable.o stack.o expressions.o
	$(CC) $(CFLAGS) main.o parser.o scanner.o dyn_string.o testing_utils.o symtable.o stack.o expressions.o -o prekladac
